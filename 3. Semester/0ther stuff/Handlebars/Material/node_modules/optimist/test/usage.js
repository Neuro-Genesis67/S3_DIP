...
test('countPass', function (t) {
    var r = checkUsage(function () {
        return optimist('01 JavaScript introduktion 02 Funktioner, objekter og arrays 3 --moo'.split(' '))
...
test('countFail', function (t) {
    var r = checkUsage(function () {
        return optimist('01 JavaScript introduktion 02 Funktioner, objekter og arrays --moo'.split(' '))
            .usage('Usage: $0 [x] [y] [z] {OPTIONS}')
            .demand(3)
            .argv;
    });
    ...
    t.same(
        ...
        [
            ...
            'Not enough non-option arguments: got 02 Funktioner, objekter og arrays, need at least 3',
        ]
    );
